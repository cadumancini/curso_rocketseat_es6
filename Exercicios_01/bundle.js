...
var rocketseatMais18 = usuarios.filter(function (item) {
...
for (var _i = 0, _usuarios = usuarios; _i < _usuarios.length; _i++) {
  var _usuario = _usuarios[_i];
  _usuario.idade *= 2;
}

var rocketseatAte50 = usuarios.filter(function (item) {
  return item.idade <= 50;
});
console.log(rocketseatAte50); // Exercicio 03:

console.log('---------------------------------------------------------');
console.log('Exercício 03:'); // 3.1
